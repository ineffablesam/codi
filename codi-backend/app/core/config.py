...
class Settings(BaseSettings):
    ...
    # Opik AI Operation Tracking (Optional)
    opik_api_key: str = ""  # Comet ML Opik API key
    opik_workspace: str = "codi"  # Default workspace
    opik_project_name: str = "codi-ai-operations"  # Default project name for traces
