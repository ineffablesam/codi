...
from app.api import agents_router, auth_router, health_router, projects_router, files_router, backend_router, containers_router, deployments_router, plans_router, chats_router, environment_router, opik_router, opik_extensions_router
...
# opik_extensions_router MUST come before opik_router since opik has catch-all /traces/{trace_id}
app.include_router(opik_extensions_router, prefix="/api/v1")
app.include_router(opik_router, prefix="/api/v1")
