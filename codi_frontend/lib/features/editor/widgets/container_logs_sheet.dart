...
class _ContainerLogsSheetState extends State<ContainerLogsSheet> {
  ...
  void initState() {
    ...
    _controller.startLogStream(widget.containerId);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF1E1E1E), // Terminal dark background
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Icon(Iconsax.monitor, color: Colors.green, size: 20.sp),
          SizedBox(width: 8.w),
          Expanded(
            child: Text(
          ...
          Obx(() => Container(
                ...
                decoration: BoxDecoration(
                  color: _controller.isStreaming.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 6.w),
                    Text(
                      _controller.isStreaming.value ? 'Live' : 'Paused',
                      style: TextStyle(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, size: 16.sp, color: color ?? Colors.white70),
            SizedBox(width: 6.w),
            Text(
              label,
              style: TextStyle(
      ...
      if (_controller.logs.isEmpty) {
        return Center(
          child: Column(
            ...
            children: [
              Icon(Iconsax.document_text, size: 48.sp, color: Colors.grey[600]),
